...
- 更新 `index.html` 中 `styles.css` / `app.js` 版本参数为 `20260525-mobile-pass2`，避免浏览器继续使用旧缓存。

验证：

- `node --check app.js` 通过。
- 本地服务 `http://127.0.0.1:4173/index.html?verify=mobile-pass2` 返回 200。
- 内置浏览器确认页面加载 `styles.css?v=20260525-mobile-pass2` 和 `app.js?v=20260525-mobile-pass2`，控制台无错误。
