...
最新状态补充（2026-06-07）：
- 道风图片牌面已按实机反馈放大：触屏横屏公共牌约 42-46px 宽，手牌约 50-53px 宽，右侧最近动作牌约 46px 宽；不可选牌置灰已调轻到 0.72，避免细节发白看不清。
...
- 最新真实页面验证截图：`artifacts/layout-check/real-index-daoist-cards-readable-4p-915x412.png`、`artifacts/layout-check/real-index-daoist-cards-readable-4p-844x390.png`、`artifacts/layout-check/real-index-daoist-cards-readable-2p-915x412.png`；验证记录为 `artifacts/layout-check/daoist-cards-readable-check.json`。
