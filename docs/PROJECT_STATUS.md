...
- 当前缓存版本已更新为：`styles.css?v=20260618-settlement-layout-fix`，`app.js?v=20260621-lobby-history-collapse`。
...
- 本轮已完成校验：`node --check app.js`；并人工复核回大厅后的 `上一局结算` 默认收起、手动点击才展开。
