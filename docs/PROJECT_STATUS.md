...
- `915 x 412` 与 `844 x 390` 本机 Chrome 预览图已生成：`artifacts/layout-check/chrome-final-915x412.png`、`artifacts/layout-check/chrome-final-844x390.png`，两张图均确认右侧最近动作文字和动作牌可见。
